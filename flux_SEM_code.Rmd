---
title: "Five years of eddy covariance data and structural equation modeling reveal an important direct role of water temperature and wind, and an indirect role of hypolimnetic dissolved oxygen in controlling methane fluxes from a small reservoir"
...
Reverse-diffusion and Ebullition (5m and 9m) model: In this concept, an ebullition pathway from both 5m and 9m depth was added to the reverse-diffusion model.
...
model_flux <- '
  ...
  iCH4_5m ~ DOsat_5m + iCH4_1.6m + mean_fDOM + sch_stab
